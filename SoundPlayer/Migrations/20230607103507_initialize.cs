        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoteUserId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoundLikesOrDislikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SoundLikesOrDislikes_Sounds_SoundId",
                        column: x => x.SoundId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SoundLikesOrDislikes_SoundId",
                table: "SoundLikesOrDislikes",
                column: "SoundId");
